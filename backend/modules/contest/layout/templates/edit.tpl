...
<div class="pageTitle">
	<h2>{$lblContest|ucfirst}: {$lblEdit}</h2>
</div>
...
{form:edit}
	...
	<div class="tabs">
		<ul>
			...
			<li><a href="#tabQuestions">{$lblQuestions|ucfirst}</a></li>
        ...
        <div id="tabQuestions">
            ...
            <div class="pageTitle">
                <h2>
                    {$lblQuestions|ucfirst}
                </h2>
                <div class="buttonHolderRight">
                    <a href="{$var|geturl:'add_question'}&contest_id={$item.id}" class="button icon iconAdd" title="{$lblAddQuestion|ucfirst}">
                        <span>{$lblAddQuestion|ucfirst}</span>
                    </a>
                </div>
            </div>
            {option:dataGrid}
