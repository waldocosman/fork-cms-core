...
<div class="pageTitle">
	<h2>{$lblProjects|ucfirst}: {$lblEdit}</h2>
</div>
					...
					<td id="leftColumn">
                        ...
                        <div class="box">
                            ...
                            <div class="options clearfix">
                                {option:item.image}
                                    <p class="imageHolder">
                                        <img src="{$FRONTEND_FILES_URL}/projects/images/128x128/{$item.image}" width="128" height="128" alt="{$lblImage|ucfirst}" />
                        ...
                        <div class="box">
                            <div class="heading">
                                <h3>{$lblSummary|ucfirst}<abbr title="{$lblRequiredField}">*</abbr></h3>
                            </div>
                            <div class="optionsRTE">
