 ...
 */
class BackendProjectsAjaxAddCategory extends BackendBaseAJAXAction
{
	/**
	 * Execute the action
	 */
	public function execute()
	{
		...
		$meta['url'] = BackendProjectsModel::getURLForCategory(SpoonFilter::urlise($item['title']));

		// update
		$item['id'] = BackendProjectsModel::insertCategory($item, $meta);
